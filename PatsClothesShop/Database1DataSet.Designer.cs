...
namespace PatsClothesShop.Database1DataSetTableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customer] ([CustomerID], [FirstName], [SecondName]) VALUES (@C" +
                "ustomerID, @FirstName, @SecondName);\r\nSELECT CustomerID, FirstName, SecondName F" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Customer] SET [CustomerID] = @CustomerID, [FirstName] = @FirstName," +
                " [SecondName] = @SecondName WHERE (([CustomerID] = @Original_CustomerID));\r\nSELE" +
                "CT CustomerID, FirstName, SecondName FROM Customer WHERE (CustomerID = @Customer" +
                "ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerID, FirstName, SecondName FROM dbo.Customer";
        ...
        public virtual int Insert(int CustomerID, string FirstName, string SecondName) {
        ...
        public virtual int Update(int CustomerID, string FirstName, string SecondName, int Original_CustomerID) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string SecondName, int Original_CustomerID) {
            return this.Update(Original_CustomerID, FirstName, SecondName, Original_CustomerID);
        }
    }
